...
<script lang="ts" setup>
    ...
    import {formSchema,cesOrderGoodsColumns,cesOrderCustomerColumns} from '../CesOrderMain.data';
    ...
    const [registerModal, {setModalProps, closeModal}] = useModalInner(async (data) => {
        ...
        if (unref(isUpdate)) {
            ...
            await setFieldsValue({
             ...
             requestSubTableData(cesOrderCustomerList, {id:data?.record?.id}, cesOrderCustomerTable)
        }
        // 隐藏底部时禁用整个表单
    ...
    async function reset(){
      ...
      cesOrderCustomerTable.dataSource = [];
    }

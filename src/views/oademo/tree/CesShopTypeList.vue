<template>
  <div>
    ...
    <!--字典弹窗-->
    <CesShopTypeModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="tree-cesShopType" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import CesShopTypeModal from './components/CesShopTypeModal.vue';
  import {columns,searchFormSchema} from './CesShopType.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteCesShopType, batchDeleteCesShopType, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './CesShopType.api';
  ...
  async function handleDelete(record) {
    await deleteCesShopType({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteCesShopType({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
